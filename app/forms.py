...
class DonateNowForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels={
            "donationpic":"Donation Image(Pic of food item you want to donate)",
...
class DonationAreaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'areaname':forms.TextInput(attrs={'class':'form-control','placeholder':'Charity Name'}),
            'description':forms.Textarea(attrs={'class':'form-control','placeholder':'Address'}),
        }
        labels={
